...
//
// 斜杠命令 `/import <source> <path>`（用户触发、不占模型轮次）：解析 source（18 个
...
const SOURCE_NAMES = 'claude/codex/chatgpt/cursor/gemini/reasonix/opencode/mimocode/zcode/grokbuild/openclaw/pi/hermes/kimi/qoder/workbuddy/dsh'
