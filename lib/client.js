...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const SOURCE_BADGES = {
      ...
      opencode: { svg: logoCard('<path d="M16 6H8v12h8V6zm4 16H4V2h16v20z" fill="#111216"/>') },
      ...
      hermes: { color: "#EA580C", text: "H" },
      kimi: { svg: logoCard('<rect x="-4" y="-4" width="32" height="32" rx="6" fill="#1783FF"/><path d="M11.065 11.199l7.257-7.2c.137-.136.06-.41-.116-.41H14.3a.164.164 0 00-.117.051l-7.82 7.756c-.122.12-.302.013-.302-.179V3.82c0-.127-.083-.23-.185-.23H3.186c-.103 0-.186.103-.186.23V19.77c0 .128.083.23.186.23h2.69c.103 0 .186-.102.186-.23v-3.25c0-.069.025-.135.069-.178l2.424-2.406a.158.158 0 01.205-.023l6.484 4.772a7.677 7.677 0 003.453 1.283c.108.012.2-.095.2-.23v-3.06c0-.117-.07-.212-.164-.227a5.028 5.028 0 01-2.027-.807l-5.613-4.064c-.117-.078-.132-.279-.028-.381z" fill="#fff"/>') },
      qoder: { color: "#0D9488", text: "Q" },
      workbuddy: { color: "#65A30D", text: "WB" },
    ...
    function SourceBadge({ format, checked, size = 26, onClick, title, ariaLabel, disabled, palette }) {
      ...
      const card = {
        width: size, height: size, borderRadius: "6px", background: "#ffffff", flex: "none",
