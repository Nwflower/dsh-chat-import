...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // 会话条目来源徽标（按 discovery format 短名键控）：圆形 brand 色底 + 白色 glyph。
    // 辨识度高的工具用真实品牌标（path 取自 simple-icons，CC0；商标归各自权利人），
    // 其余无公开 brand 标的用 1–3 字母缩写；未命中时按 format 首字母兜底。
    const SOURCE_BADGES = {
      ...
      codex: { color: "#1F2937", text: "Cx" },
      chatgpt: { color: "#10A37F", text: "GPT" },
      cursor: { color: "#000000", path: "M11.503.131 1.891 5.678a.84.84 0 0 0-.42.726v11.188c0 .3.162.575.42.724l9.609 5.55a1 1 0 0 0 .998 0l9.61-5.55a.84.84 0 0 0 .42-.724V6.404a.84.84 0 0 0-.42-.726L12.497.131a1.01 1.01 0 0 0-.996 0M2.657 6.338h18.55c.263 0 .43.287.297.515L12.23 22.918c-.062.107-.229.064-.229-.06V12.335a.59.59 0 0 0-.295-.51l-9.11-5.257c-.109-.063-.064-.23.061-.23" },
      ...
      reasonix: { color: "#7C3AED", text: "RX" },
      opencode: { color: "#2563EB", text: "OC" },
      mimocode: { color: "#DB2777", text: "MM" },
      kilocode: { color: "#F59E0B", text: "KC" },
      zcode: { color: "#0EA5E9", text: "Z" },
      grokbuild: { color: "#000000", path: "M14.234 10.162 22.977 0h-2.072l-7.591 8.824L7.251 0H.258l9.168 13.343L.258 24H2.33l8.016-9.318L16.749 24h6.993zm-2.837 3.299-.929-1.329L3.076 1.56h3.182l5.965 8.532.929 1.329 7.754 11.09h-3.182z" },
      openclaw: { color: "#059669", text: "CL" },
      pi: { color: "#F43F5E", text: "π" },
      hermes: { color: "#F97316", text: "H" },
      kimi: { color: "#3B82F6", text: "K" },
      qoder: { color: "#14B8A6", text: "Q" },
      workbuddy: { color: "#84CC16", text: "WB" },
      qwen: { color: "#6366F1", text: "QW" },
    ...
    // 多选徽标（替换原生 checkbox）：圆形 brand 色底 + 白色 logo/首字母。未选中只显
    // 徽标；选中时叠一层半透明主题强调色遮罩 + 带环 tick（环/勾颜色随主题文字色）。
    // role=checkbox + aria-checked + 键盘 Enter/Space 切换，保留原 checkbox 的可访问性。
    function SourceBadge({ format, checked, size = 26, onClick, title, ariaLabel, disabled, palette }) {
      ...
      const base = {
        width: size, height: size, borderRadius: "50%", flex: "none", cursor: disabled ? "default" : "pointer",
        display: "flex", alignItems: "center", justifyContent: "center",
        border: "1px solid " + palette.border, position: "relative", overflow: "hidden",
        padding: 0, background: badge.color, opacity: disabled ? 0.5 : 1,
      };
      const glyph = badge.path
        ? React.createElement("svg", {
          viewBox: "0 0 24 24", width: Math.round(size * 0.62), height: Math.round(size * 0.62),
          fill: "#ffffff", "aria-hidden": true, style: { display: "block" },
        }, React.createElement("path", { d: badge.path }))
        : React.createElement("span", {
          style: {
            color: "#ffffff", fontWeight: 700, lineHeight: 1, letterSpacing: "-0.02em",
      ...
      return React.createElement("div", {
        style: base, title, "aria-label": ariaLabel, role: "checkbox", "aria-checked": checked,
